...
public class Customer implements Runnable
{
	...
	public void run()
	{
		...
		PostOfficeSimulator.line_count++;   ////can comment 
	...
	// 	this.
	// System.out.println( "Customer " + num + " "+ PostOfficeSimulator.serviceDisplay(1, this.customer_service) +" customer "+this.customer_id+"." );	
